...
namespace Common.Authentication
{
    public static class Extensions
    {
        ...
        public static void AddJwt(this IServiceCollection serviceCollection, string sectionName = SectionName,
        ...
        private static void AddJwt(this IServiceCollection serviceCollection, JwtOptions options,
            Action<JwtBearerOptions> optionsFactory = null)
        {
